...
# 1. Data preparation
ko_data <- read.csv("DC_nmds.csv", row.names = 1, check.names = FALSE)
...
ggsave("DC_NMDS_with_Groups.pdf", width = 8, height = 6)
write.csv(nmds_points, "DC_NMDS_coordinates_with_groups.csv")
...
write.csv(bray_matrix, "DC_BrayCurtis_DistanceMatrix.csv")
...
write.csv(sample_diversity, "DC_Sample_BrayCurtis_Diversity.csv", row.names = FALSE)
...
ggsave("DC_Sample_MeanBrayCurtis_Distance.pdf", avg_dist_plot, width = 12, height = 6)
...
ggsave("DC_BrayCurtis_DistanceHeatmap.pdf", heatmap_plot, width = 10, height = 8)
...
ggsave("DC_NMDS_with_BrayCurtis_Color.pdf", nmds_bray_plot, width = 10, height = 8)
...
ggsave("DC_Classical_MDS_BrayCurtis.pdf", mds_plot, width = 10, height = 8)
...
cat("1. DC_BrayCurtis_DistanceMatrix.csv - Complete Bray-Curtis distance matrix\n")
cat("2. DC_Sample_BrayCurtis_Diversity.csv - Bray-Curtis diversity metrics for each sample\n")
cat("3. DC_Sample_MeanBrayCurtis_Distance.pdf - Bar plot of the mean distance for each sample\n")
cat("4. DC_BrayCurtis_DistanceHeatmap.pdf - Bray-Curtis distance heatmap\n")
cat("5. DC_NMDS_with_BrayCurtis_Color.pdf - NMDS plot colored by Bray-Curtis distance\n")
cat("6. DC_Classical_MDS_BrayCurtis.pdf - Classical MDS analysis plot\n")
